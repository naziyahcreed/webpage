    ...
    <section className="bg-[var(--bg-primary)] text-[var(--text-primary)] py-12 px-6 sm:px-12  ">
      <div className="max-w-10xl mx-auto flex flex-col md:flex-row items-center justify-center ">
        ...
        <motion.div 
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-0 flex justify-center items-center golden-text">
            About Us
          </h2>
          <p className="text-[var(--text-secondary)] leading-relaxed m-1 text-xl font-sans h-fit">
            ...
            <span className="golden-text font-bold"> Automation</span>, 
            <span className="golden-text font-bold"> IoT</span>, and 
            <span className="golden-text font-bold"> Robotics</span> for Diploma and UG engineering students. 
            <br /><br />
            We specialize in cutting-edge platforms like 
            <span className="golden-text font-bold"> Arduino, Raspberry Pi, ESP32, and Python</span>.
            ...
            With award-winning experience in <span className="golden-text font-bold">MSME</span> projects, 
